...
function IoAddPathForProtection(hDevice: THandle; FullPath: PWideChar; WeakProtection: LongBool; var UniqueKey: DWORD): LongBool;
...
begin
  ...
  InPacket.WeakProtection := WeakProtection;
